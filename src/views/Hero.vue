<template>
    <div class="target" ref="targetEl" v-motion-roll-bottom>
        <section id="home" class="hero bg-zinc-100 dark:bg-zinc-800">
            ...
            <div class="content py-6 items-center gap-x-12 pb-[500px]">
                <div class="hero-main w-1/3 h-80 items-center border-2 flex-col md:flex-row relative">
                    ...
                    <div class="hero-text md:flex-row text-center md:text-left">
                        <h1 class="font-bold dark:text-slate-300 text-center md:text-left">Hi<span class="wave">👋</span>
                        </h1>
                        <h1 class="text-3xl font bold dark:text-slate-300 text-center md:text-left">My name is <span
