<template>
    <div class="flex flex-row space-x-8">
        <a target="_blank" href="https://github.com/jarvin-s/portfolio"
            ...
            <svg class="dark:fill-zinc-300 dark:hover:fill-zinc-200 dark:fill-white hover:fill-zinc-500" xmlns="http://www.w3.org/2000/svg"
        ...
        <button
            ...
            <div class="dark:hidden flex">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="fill-zinc-100 w-5 h-4">
